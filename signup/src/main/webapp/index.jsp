...
<title>Simple Website by sudoshivesh</title>
<!-- Favicon-->
...
<body id="page-top">
	...
	<nav
		...
		id="mainNav">
		<div class="container">
			<a class="navbar-brand" href="#page-top">sudoshivesh</a>
			<button
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ms-auto">
					<li class="nav-item mx-0 mx-lg-1"><a
						class="nav-link py-3 px-0 px-lg-3 rounded" href="https://sudoshivesh.github.io/">Portfolio</a></li>
					<li class="nav-item mx-0 mx-lg-1"><a
	...
	<header class="masthead bg-primary text-white text-center">
		<div class="container d-flex align-items-center flex-column">
			...
			<img class="masthead-avatar mb-5" src="assets/img/avataaars.svg"
				alt="..." />
			<!-- Masthead Heading-->
			<h1 class="masthead-heading text-uppercase mb-0">Welcome To sudoshivesh Website</h1>
			<!-- Icon Divider-->
			...
			<!-- Masthead Subheading-->
			<p class="masthead-subheading font-weight-light mb-0">4th Year CSE Geek | Passionate | Being a Developer</p>
		</div>
	</header>
	<!-- Portfolio Section-->
	...
	<section class="page-section bg-primary text-white mb-0" id="about">
		<div class="container">
			...
			<h2
				class="page-section-heading text-center text-uppercase text-white">About sudoshivesh</h2>
			<!-- Icon Divider-->
			<div class="divider-custom divider-light">
				<div class="divider-custom-line"></div>
				<div class="divider-custom-icon">
			...
			<div class="row">
				<div class="col-lg-4 ms-auto">
					<p class="lead">sudoshivesh is a 4th year cse geek who is passionate about
					coding and developing interactive and optimal solution for challenging problem.
					This website is just a demonstration of using Advance Java in website.</p>
				</div>
				<div class="col-lg-4 me-auto">
					<p class="lead">This website I have made for the demonstration of login
					validation using Java Servlet and JSP. This is for trial purpose. It will
					be modified later. Connect with me : <a href="https://www.linkedin.com/in/sudoshivesh"><font color="black">Shivesh</font></a></p>
				</div>
			</div>
		</div>
	</section>
	...
	<footer class="footer text-center">
		<div class="container">
			<div class="row">
				...
				<!-- Footer About Text-->
				<div class="col-lg-4">
					<h4 class="text-uppercase mb-4">About sudoshivesh</h4>
					<p class="lead mb-0">
						sudoshivesh is a 4th year geek. To know more, Connect with him at: <a href="https://www.linkedin.com/in/sudoshivesh/">Shivesh</a> .
					</p>
				</div>
			</div>
		</div>
	...
	<div class="copyright py-4 text-center text-white">
		<div class="container">
			<small>Copyright &copy; sudoshivesh 2023</small>
		</div>
	</div>
	<!-- Portfolio Modals-->
	<!-- Portfolio Modal 1-->
